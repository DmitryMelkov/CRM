import { deleteClientModal } from './modules/createDeleteModal.js';
import { editClientModal } from './modules/editClient.js';
import { createContactItemByType, formatDate, formatTime } from './modules/utils.js';

//создание клиента в таблице
